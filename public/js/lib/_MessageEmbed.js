...
export class _MessageEmbed extends Base {
    constructor(client, message, embedOptions, node) {
        super(client);
        this.node = node;
    ...
    layout() {
        if (this.data.thumbnail && !this.data.author && !this.data.color && !this.data.description) {
            if (this.message.links && this.message.links.length === 1) {
                if (this.message.content.textContent === this.message.links[0])
                    this.message.content.innerHTML = '';
            }
...
//# sourceMappingURL=_MessageEmbed.js.map